  ...
  async function handleExportPngs() {
    ...
    try {
      ...
      for (let i = 0; i < slides.length; i++) {
        // Navigate to this slide (disable transition for clean capture)
            ...
            <div className="card fade-in">
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-0.5">1080×1080px · Click a slide to download it individually</p>
                </div>
                <button
              ...
              <p className="text-xs text-gray-400 mt-3">
                💡 To post on LinkedIn: upload all 6 images in a single post, or combine them into a PDF for native carousel swipe.
              </p>
            </div>
          )}
